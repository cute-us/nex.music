...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/hinata-exe/nex.music",
)
...
# ------------------------------------------------------------------------
# -------------------------------------------------------------------------
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/New_Animes_Hindi_Dubbed")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/121f74268bc6f99ac9a6e.jpg"
)
PING_IMG_URL = getenv(
